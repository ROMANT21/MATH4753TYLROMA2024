...
#' @param x the sample
#' @param param the parameter values to test for
#' @param ...
#'
#' @return a graph and information about the parameter that maximizes the likelihood function
#' @export
#'
#' @examples
#' y = c(3, 3, 4, 3, 4, 5, 5, 4)
#'logbin = function(x, param) log(dbinom(x, prob=param, size=20))
#'mymaxlik(lfun=logbin, x=y, param=seq(0, 1, length=1000), main="Binomiial, n=20")
